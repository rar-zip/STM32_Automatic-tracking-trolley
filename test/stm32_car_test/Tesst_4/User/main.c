...
#define DEAD_ZONE      8       // 死区阈值（减小，响应更快）
#define DAMPING_FACTOR 0.25    // 阻尼系数（减小，响应更快）

// 分级转向参数 - 根据方向自适应调整
#define STRAIGHT_SENSITIVITY 0.06  // 直行灵敏度（提高）
#define STRAIGHT_MAX_DIFF    8     // 直行最大速度差（提高）
#define LEFT_TURN_SENSITIVITY  0.10  // 左转灵敏度（提高）
#define LEFT_TURN_MAX_DIFF     20    // 左转最大速度差（提高）
#define RIGHT_TURN_SENSITIVITY 0.10  // 右转灵敏度（提高）
#define RIGHT_TURN_MAX_DIFF    20    // 右转最大速度差（提高）

// 急弯额外补偿
#define SHARP_BEND_BOOST 0.05   // 急弯时额外增加的灵敏度（提高）
#define SHARP_BEND_DIFF_BOOST 12 // 急弯时额外增加的速度差（提高）
#define SHARP_BEND_THRESHOLD 60 // 急弯阈值（降低，更容易触发）
